...
class Xcrud_xss {
	...
	public function xss_clean($str, $is_image = FALSE)
	{
		...
		$str = preg_replace_callback('#<(/*\s*)('.Xcrud_config::$xss_naughty_html.')([^><]*)([><]*)#is', array($this, '_sanitize_naughty_html'), $str);
		 ...
		 */
		$str = preg_replace('#('.Xcrud_config::$xss_naughty_scripts.')(\s*)\((.*?)\)#si', "\\1\\2&#40;\\3&#41;", $str);
	...
	protected function _remove_evil_attributes($str, $is_image)
	{
		...
		$evil_attributes = Xcrud_config::$xss_disalowed_attibutes;
	...
	{
		return $this->entity_decode($match[0], strtoupper(Xcrud_config::$mbencoding));
	}
